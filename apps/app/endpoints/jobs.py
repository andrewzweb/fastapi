...
from app.endpoints.depends import get_current_user, get_job_repository
from app.models.jobs import Job, JobIn
...
async def delete_job(id: int,
    ...
    if job is None or job.user_id != int(current_user.id):
